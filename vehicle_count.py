...
cap = cv2.VideoCapture('videos2.mp4')
input_size = 320
...
image_file = 'vehicle classification-image.png'
def from_static_image(image):
    ...
    outputNames = [layersNames[i[0] - 1] for i in outputLayers]
